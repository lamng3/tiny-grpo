...
**Goal**: Implementation of GRPO for training a local `llama-3.2-3b` model using RL. Focus on understanding GRPO algorithm. Run everything locally on a single RTX A6000 node and Axolotl Docker image on RunPod.
